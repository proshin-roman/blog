...
@Slf4j
class ReCaptchaFilter implements Filter {

    private final SimpleUrlAuthenticationFailureHandler failureHandler;
    private final ReCaptchaCodeVerifier codeVerifier;

    ReCaptchaFilter(@NonNull SimpleUrlAuthenticationFailureHandler failureHandler,
            @NonNull String reCaptchaSecret, @NonNull RestTemplate restTemplate) {
